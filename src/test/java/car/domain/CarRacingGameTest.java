...
class CarRacingGameTest {
    ...
    void positivePlayCount() {
        assertThatNoException()
                .isThrownBy(() -> CarRacingGame.createDefault(List.of("a", "b"), 1));
    }
    ...
    void negativePlayCount(final int playCount) {
        assertThatExceptionOfType(IllegalArgumentException.class)
                .isThrownBy(() -> CarRacingGame.createDefault(List.of("a", "b"), playCount));
    }
    ...
    void repeatedlyPlayRace(final int playCount) {
        final CarRacingGame game = CarRacingGame.createDefault(List.of("a", "b"), playCount);
    ...
    void formatCars() {
        final CarRacingGame game = CarRacingGame.createDefault(List.of("a", "b"), 1);
    ...
    void resolveWinnerNames() {
        ...
        assertThat(game.resolveWinnerNames(carList -> List.of(new Car("a"), new Car("b"))))
                .containsExactly(new Name("a"), new Name("b"));
    }
